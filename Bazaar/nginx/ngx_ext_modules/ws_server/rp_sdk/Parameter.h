...
template <typename T, typename ValueT>
inline CParameter<T, ValueT>::CParameter(ParameterType pType, std::string _name, AccessMode _access_mode, ValueT _value, int _fpga_update, T _min, T _max) : CBaseParameter(pType) {
    m_Value.name = _name;
...
template <typename T, typename ValueT>
inline CParameter<T, ValueT>::CParameter(ParameterType pType, std::string _name, AccessMode _access_mode, const ValueT& _value) : CBaseParameter(pType) {
    m_Value.name = _name;
    m_Value.value = _value;
    //	m_Value.min;
    //	m_Value.max;
